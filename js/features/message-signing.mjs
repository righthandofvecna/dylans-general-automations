...
export function register() {
  ...
  game.settings.register(MODULENAME, "enableMessageSigning", {
    name: "Enable Message Signing",
    hint: "If enabled, certain module features will cryptographically sign messages to verify they were generated by an authorized GM user. Requires a secure context (HTTPS or localhost).",
    scope: "world",
    config: true,
    type: Boolean,
    default: true,
